...
HD_PWD='/home/ispr/Documentos/ispr/tutorials/lab2/hw/project/lab2.runs/system_switches_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_switches_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_switches_0.tcl
